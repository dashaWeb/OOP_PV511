...
// визначити глоб. функцію для обчислення площі трикутника за 3-ма дробовими сторонами(ф-ла Герона)
// якщо  сторона  менша або  рівна 0  кидати виняток зі значенням сторони
// якщо  трикутник не  складається, то  кидати виняток (типу string) виду "НЕ підходить сторона 12"
// 
// Клас Прямокутник(дробові сторони). 
//Класи винятків : відємна ширина, відємна довжина, нульова ширина, нульова довжина(message, badSide).
// setLength() setWidth () -  повинні кидати винятки відповідного. Продемонструвати обробку винятків у main()