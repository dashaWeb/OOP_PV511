...
int main()
{
	...
	if (a != nullptr) // ok cast
	{
		...
		cout << "Untenable cast " << person->getName() << " to Aspirant " << endl;
	}

	cout << "\n\n";

	vector<Person*> people{ &ann, &ivan, &matviy };
	cout << " _____________ People ____________" << endl;
	for (Person* p : people)
	{
		p->print();
	...
	cout << "_____________ TYPEID ________________" << endl;
	auto val = 12.34;
	...
	cout << "\n\n typeid _____________ People ____________" << endl;
	for (Person* p : people)
	{
		p->print();
